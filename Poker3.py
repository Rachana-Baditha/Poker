...
class card:
    ...
    def drawcard(self):
        ...
        if self.s == 1:
            return heart[self.n -2]
        elif self.s == 2:
            return spade[self.n -2]
        elif self.s == 3:
            return club[self.n -2]
        elif self.s == 4:
            return diamond[self.n -2]


def redrawGameWindow(round,p1,p2,board):
    global backcard
    ...
    if round < 30:
        #Hide p2 cards
        wn.blit(backcard,(250,40))
        wn.blit(backcard,(390,40))
        
    else:
        #Reveal p2 cards
        wn.blit(p2[0].drawcard(),(250,40))
        wn.blit(p2[1].drawcard(),(390,40))
        pass
    ...
    if round <10:
        #Show first 3 cards
        wn.blit(board[0].drawcard(),(40,210))
        wn.blit(board[1].drawcard(),(180,210))
        wn.blit(board[2].drawcard(),(320,210))
        wn.blit(backcard,(460,210))
        wn.blit(backcard,(600,210))
        ...
        wn.blit(board[1].drawcard(),(180,210))
        wn.blit(board[2].drawcard(),(320,210))
        wn.blit(board[3].drawcard(),(460,210))
        wn.blit(backcard,(600,210))
        pass
    else:
        #Show all cards
        ...
        wn.blit(board[2].drawcard(),(320,210))
        wn.blit(board[3].drawcard(),(460,210))
        wn.blit(board[4].drawcard(),(600,210))
        pass
    
    #Draw P1 Cards
    wn.blit(p1[0].drawcard(),(250,380))
    wn.blit(p1[1].drawcard(),(390,380))
...
wn = pygame.display.set_mode((720,550))

pygame.display.set_caption("Poker")

heart = [pygame.image.load("2H.png"), pygame.image.load("3H.png"), pygame.image.load("4H.png"), pygame.image.load("5H.png"), pygame.image.load("6H.png"), pygame.image.load("7H.png"), pygame.image.load("8H.png"), pygame.image.load("9H.png"), pygame.image.load("10H.png"), pygame.image.load("JH.png"), pygame.image.load("QH.png"), pygame.image.load("KH.png"), pygame.image.load("AH.png")]
spade = [pygame.image.load("2S.png"), pygame.image.load("3S.png"), pygame.image.load("4S.png"), pygame.image.load("5S.png"), pygame.image.load("6S.png"), pygame.image.load("7S.png"), pygame.image.load("8S.png"), pygame.image.load("9S.png"), pygame.image.load("10S.png"), pygame.image.load("JS.png"), pygame.image.load("QS.png"), pygame.image.load("KS.png"), pygame.image.load("AS.png")]
club = [pygame.image.load("2C.png"), pygame.image.load("3C.png"), pygame.image.load("4C.png"), pygame.image.load("5C.png"), pygame.image.load("6C.png"), pygame.image.load("7C.png"), pygame.image.load("8C.png"), pygame.image.load("9C.png"), pygame.image.load("10C.png"), pygame.image.load("JC.png"), pygame.image.load("QC.png"), pygame.image.load("KC.png"), pygame.image.load("AC.png")]
diamond = [pygame.image.load("2D.png"), pygame.image.load("3D.png"), pygame.image.load("4D.png"), pygame.image.load("5D.png"), pygame.image.load("6D.png"), pygame.image.load("7D.png"), pygame.image.load("8D.png"), pygame.image.load("9D.png"), pygame.image.load("10D.png"), pygame.image.load("JD.png"), pygame.image.load("QD.png"), pygame.image.load("KD.png"), pygame.image.load("AD.png")]
    
backcard = pygame.image.load("red_back.png")
...
while run:
    ...
    redrawGameWindow(round,player1,player2,board)
